...
<body>
    <header class="header">
        <nav class="navbar">
            <div class="logo">
                <a href="#home">
                    <img class="logo-white" src="assets/img/meylogo-white.png">
                    <img class="logo-black" src="assets/img/meylogo-black.png">
                </a>
            </div>
            <div class="nav-links">
            ...
            <div class="nav-right">
                <div class="cv-button">
                    <a href="assets/files/turkce-cv.pdf" download class="shop-btn">
                       ...
                       <span class="desk-cv-span">CV İndir</span>
                       <span class="mob-cv-span">CV</span> 
                    </a>
                </div>
            </div>
            <div class="hamburger">
